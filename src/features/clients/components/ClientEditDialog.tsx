...
import { UsuarioDto, DepartmentColombian, CityColombian } from '@/shared/types';
import { updateUsuario, getDepartments, getCitiesByDepartment, getUsuarios } from '@/shared/services/api';

...
import { VentaPedidoDto, UsuarioDto, Producto } from '@/shared/types/index';
import { getUsuarios, getProductos, getVentaPedidoById, getEstados, getDetalleVentaPedidos } from '@/shared/services/api';
import {
  ArrowLeft,
  MapPin,
  Phone,

...
import { Categoria, ImageneDto, UsuarioDto, RolDto, RolPermisoDto, PermisoDto, Producto, ProductoDto, VentaPedidoDto, DetalleVentaPedidoDto, DevolucionDto, DetalleDevolucionDto, DepartmentColombian, CityColombian, Proveedor, CompraDto, VentaAbonoDto, CotizacionDto, DetalleCotizacionDto } from '@/shared/types';
